...
/// <summary>
///     Stub implementation of ILlmService for E2E testing.
/// </summary>
internal class StubLlmService : ILlmService
{
    ...
    public Task<Result<SubagentResult>>
        InvokeSubagentAsync(string prompt, SubagentOptions options, CancellationToken ct) =>
