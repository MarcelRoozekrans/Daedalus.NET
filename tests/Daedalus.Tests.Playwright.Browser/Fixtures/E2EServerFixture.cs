...
#pragma warning restore CS0618
            ...
            RemoveAndReplace<ILlmService, StubLlmService>(builder.Services);
            RemoveAndReplace<IMcpAgentSelector, StubMcpAgentSelector>(builder.Services);
            RemoveAndReplace<IContext7DocumentationInjector, StubContext7DocumentationInjector>(builder.Services);
