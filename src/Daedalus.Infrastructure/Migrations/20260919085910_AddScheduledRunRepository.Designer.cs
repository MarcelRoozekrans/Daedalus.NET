...
namespace Daedalus.Infrastructure.Migrations
{
    ...
    [Migration("20260919085910_AddScheduledRunRepository")]
    partial class AddScheduledRunRepository
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Daedalus.Domain.Entities.ChannelConversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ChannelId", "ConversationId")
                        .IsUnique()
                        .HasDatabaseName("IX_ChannelConversation_Channel_Conversation");

                    b.ToTable("ChannelConversations", (string)null);
                });
            ...
            modelBuilder.Entity("Daedalus.Domain.Entities.ScheduledRun", b =>
                {
                    ...
                    b.Property<int>("MissedOccurrences")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("Name")
                        .IsUnique()
                        .HasDatabaseName("IX_ScheduledRun_Name");

                    b.HasIndex("Enabled", "NextRunAt")
                        .HasDatabaseName("IX_ScheduledRun_Enabled_NextRunAt");

                    b.ToTable("ScheduledRuns", (string)null);
                });

            modelBuilder.Entity("Daedalus.Domain.Entities.ScheduledRunExecution", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ScheduledRunExecutions", (string)null);
                });

            modelBuilder.Entity("Daedalus.Domain.Entities.Skill", b =>
                {
