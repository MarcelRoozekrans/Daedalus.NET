...
/// <summary>
///     Queries the diagnostic state of scheduled runs: retrieving the current state of all active schedules
///     and the historical execution details of a single schedule's runs.
/// </summary>
public interface IScheduleDiagnostics
{
    /// <summary>Gets a summary of all active schedules' current state and the verdict on each run in progress.</summary>
    /// <param name="ct">Cancellation token.</param>
    /// <returns>An overview of all active schedules and their current runs.</returns>
