...
| # | Phase | Status |
|---|---|---|
| 1.1 | Thalos.NET core + AI.Sentinel + Daedalus HTTP/Blazor channel | complete (2026-08-16; nuget.org publish of Thalos.NET 0.1.0 pending, see #227) |
| 1.2 | Memory: `Thalos.NET.Memory` port + Rag.NET adapter | pending |
| 1.3 | Skills | pending |
