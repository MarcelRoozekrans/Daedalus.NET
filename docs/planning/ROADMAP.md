...
| 1.4 | Channels: Telegram (+ CLI) via `IChannelAdapter` + `ZeroAlloc.Outbox` | active (started 2026-08-20) | 1.1 | #230 | design: `docs/plans/2026-08-20-thalos-channels-design.md` · plan A (Thalos.NET repo): `docs/plans/2026-08-20-thalos-channels-plan-a.md` — **complete, in review at [Thalos.NET#41](https://github.com/MarcelRoozekrans/Thalos.NET/pull/41)** (916 tests, breaking change to `IChannelAdapter`) · plan B (Daedalus): not started, blocked on Thalos.NET 0.4.0 reaching nuget.org |
