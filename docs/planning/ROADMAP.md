...
| 1.2 | Memory: `Thalos.NET.Memory` port + Rag.NET adapter (pgvector), replaces hand-rolled learnings slice | active (design 2026-08-17) | 1.1 | #228 | design: `docs/plans/2026-08-17-thalos-memory-design.md` |
