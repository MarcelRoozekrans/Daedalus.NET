...
| 1.4 | Channels: Telegram (+ CLI) via `IChannelAdapter` + `ZeroAlloc.Outbox` | active (started 2026-08-20) | 1.1 | #230 | design: `docs/plans/2026-08-20-thalos-channels-design.md` |
