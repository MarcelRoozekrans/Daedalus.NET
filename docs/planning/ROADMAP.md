...
| 1.5 | Subagents & autonomous runs: `ISubagentRunner` (Thalos 0.5.0) + `ZeroAlloc.Saga` orchestration + `ZeroAlloc.Scheduling` sweeper | Backend | active (plan A merged 2026-09-17; plan B not started) | 1.1, 1.4 | #231 | design: `docs/plans/2026-09-16-thalos-subagents-design.md` · plan A (Thalos.NET repo): `docs/plans/2026-09-16-thalos-subagents-plan-a.md` — merged via [Thalos.NET#99](https://github.com/MarcelRoozekrans/Thalos.NET/pull/99), 0.5.0 release pending · plan B (Daedalus): `docs/plans/2026-09-16-thalos-subagents-plan-b.md` |
