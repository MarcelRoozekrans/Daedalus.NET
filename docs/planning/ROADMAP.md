...
| 1.5 | Subagents & autonomous runs: `ISubagentRunner` (Thalos 0.5.0) + `ZeroAlloc.Saga` orchestration + `ZeroAlloc.Scheduling` sweeper | Backend | pending | 1.1, 1.4 | #231 | design: `docs/plans/2026-09-16-thalos-subagents-design.md` |
